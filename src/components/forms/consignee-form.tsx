...
interface ConsigneeFormProps {
  initialData?: Partial<ConsigneeFormData>
  isEdit?: boolean
  consigneeId?: string
}

export default function ConsigneeForm({ initialData, isEdit = false, consigneeId }: ConsigneeFormProps) {
